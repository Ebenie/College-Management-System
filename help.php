...
<html>	
	...
	<body>
		...
		<div>
		<h2 style="margin-left:300px;text-align:center;font-size:30px;">Welcome <?php echo $user; ?></h2>	
...
.			
			...
			<form style="text-align:center">
                <input type="text" placeholder="Search for help here" style="height:40px;width:200px;border-radius:20px;"><button type="submit" style="height:40px;width:80px;border-radius:20px;">Search</button>
            </form>
