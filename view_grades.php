...
$sql = "SELECT course.course_name, result.stud_id, result.grade 
        FROM course
        JOIN result ON course.course_id = result.course_id
        WHERE result.stud_id = '$id'";
...
<div style="margin-left:25%;">
    ...
    <h3>All Your Course Grades Are Here</h3>
    <br><br>
    <table>
        <tr>
            <th>Course</th>
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><td colspan='2'>Still you have no grades!</td></tr>";
        }
        ?>
    </table>
    <br>
